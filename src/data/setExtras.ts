...
export const SET_EXTRAS: Record<string, SetMetaExtra> = {
  SV1V: {
    ...
    nameKR_full: "스칼렛 ex",
    packPriceJPY: krwToJpy(5500), boxPriceJPY: krwToJpy(155000), msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2023-01-20", packsPerBox: 30,
  },
  SV1S: {
  ...
  SV1a: {
    ...
    nameKR_full: "트리플렛 비트",
    packPriceJPY: krwToJpy(3500), boxPriceJPY: krwToJpy(95000), msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2023-03-10", packsPerBox: 30,
  },
  SV2D: {
    code: "SV2D", releasedKR: true,
    packPriceKR: 2400, boxPriceKR: 72000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2023-07-21",
    nameKR_full: "클레이 버스트",
    packPriceJPY: krwToJpy(3200), boxPriceJPY: krwToJpy(84000), msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2023-04-14", packsPerBox: 30,
  },
  SV2P: {
  ...
  SV2a: {
    ...
    packPriceJPY: krwToJpy(28000), boxPriceJPY: krwToJpy(500000), msrpPackJPY: 550, msrpBoxJPY: 11000, releaseJP: "2023-06-16", packsPerBox: 20,
  },
  SV3: {
    code: "SV3", releasedKR: true,
    packPriceKR: 4000, boxPriceKR: 120000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2023-10-27",
    nameKR_full: "흑염의 지배자",
    packPriceJPY: krwToJpy(6500), boxPriceJPY: krwToJpy(175000), msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2023-07-28", packsPerBox: 30,
  },
  SV3a: {
    code: "SV3a", releasedKR: true,
    packPriceKR: 2400, boxPriceKR: 70000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2023-11-24",
    nameKR_full: "레이징 서프",
    packPriceJPY: krwToJpy(3300), boxPriceJPY: krwToJpy(90000), msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2023-09-22", packsPerBox: 30,
  },
  SV4K: {
    code: "SV4K", releasedKR: true,
    packPriceKR: 2100, boxPriceKR: 62000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2024-01-26",
    nameKR_full: "고대의 포효",
    packPriceJPY: krwToJpy(3000), boxPriceJPY: krwToJpy(80000), msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2023-10-27", packsPerBox: 30,
  },
  SV4M: {
  ...
  SV4a: {
    ...
    packPriceJPY: krwToJpy(12000), boxPriceJPY: krwToJpy(220000), msrpPackJPY: 550, msrpBoxJPY: 5500, releaseJP: "2023-12-01", packsPerBox: 10,
  },
  SV5K: {
    code: "SV5K", releasedKR: true,
    packPriceKR: 2000, boxPriceKR: 58000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2024-04-26",
    nameKR_full: "와일드 포스",
    packPriceJPY: krwToJpy(2800), boxPriceJPY: krwToJpy(75000), msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2024-01-26", packsPerBox: 30,
  },
  SV5M: {
  ...
  SV5a: {
    ...
    nameKR_full: "크림슨 헤이즈",
    packPriceJPY: krwToJpy(3300), boxPriceJPY: krwToJpy(90000), msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2024-03-22", packsPerBox: 30,
  },
  SV6: {
    code: "SV6", releasedKR: true,
    packPriceKR: 2100, boxPriceKR: 60000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2024-08-30",
    nameKR_full: "변환의 가면",
    packPriceJPY: krwToJpy(3300), boxPriceJPY: krwToJpy(90000), msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2024-04-26", packsPerBox: 30,
  },
  SV6a: {
    code: "SV6a", releasedKR: true,
    packPriceKR: 3000, boxPriceKR: 88000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2024-09-27",
    nameKR_full: "나이트 원더러",
    packPriceJPY: krwToJpy(4500), boxPriceJPY: krwToJpy(120000), msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2024-06-07", packsPerBox: 30,
  },
  SV7: {
    code: "SV7", releasedKR: true,
    packPriceKR: 2300, boxPriceKR: 65000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2024-11-15",
    nameKR_full: "스텔라 미라클",
    packPriceJPY: krwToJpy(3700), boxPriceJPY: krwToJpy(100000), msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2024-07-19", packsPerBox: 30,
  },
  SV7a: {
    ...
    packPriceJPY: krwToJpy(4500), boxPriceJPY: krwToJpy(125000), msrpPackJPY: 165, msrpBoxJPY: 4950, releaseJP: "2024-09-13", packsPerBox: 30,
  },
  SV8: {
    code: "SV8", releasedKR: true,
    packPriceKR: 2400, boxPriceKR: 70000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2025-02-21",
    nameKR_full: "초전 브레이커",
    packPriceJPY: krwToJpy(3800), boxPriceJPY: krwToJpy(105000), msrpPackJPY: 180, msrpBoxJPY: 5400, releaseJP: "2024-10-18", packsPerBox: 30,
  },
  SV8a: {
    ...
    packPriceJPY: krwToJpy(9500), boxPriceJPY: krwToJpy(180000), msrpPackJPY: 550, msrpBoxJPY: 5500, releaseJP: "2024-12-06", packsPerBox: 10,
  },
  SV9: {
    code: "SV9", releasedKR: true,
    packPriceKR: 3200, boxPriceKR: 95000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2025-06-20",
    nameKR_full: "배틀 파트너즈",
    packPriceJPY: krwToJpy(4500), boxPriceJPY: krwToJpy(125000), msrpPackJPY: 180, msrpBoxJPY: 5400, releaseJP: "2025-01-24", packsPerBox: 30,
  },
  SV9a: {
    code: "SV9a", releasedKR: true,
    packPriceKR: 4500, boxPriceKR: 135000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2025-07-25",
    nameKR_full: "열풍의 아레나",
    packPriceJPY: krwToJpy(6500), boxPriceJPY: krwToJpy(175000), msrpPackJPY: 180, msrpBoxJPY: 5400, releaseJP: "2025-03-14", packsPerBox: 30,
  },
  SV10: {
    code: "SV10", releasedKR: true,
    packPriceKR: 3700, boxPriceKR: 110000, msrpPackKR: 2200, msrpBoxKR: 66000, releaseKR: "2025-09-19",
    nameKR_full: "로켓단의 영광",
    packPriceJPY: krwToJpy(6000), boxPriceJPY: krwToJpy(165000), msrpPackJPY: 180, msrpBoxJPY: 5400, releaseJP: "2025-05-30", packsPerBox: 30,
  },
  SV11W: {
    code: "SV11W", releasedKR: true,
    packPriceKR: 3500, boxPriceKR: 105000, msrpPackKR: 2400, msrpBoxKR: 72000, releaseKR: "2026-02-27",
    nameKR_full: "화이트 플레어",
    packPriceJPY: krwToJpy(5500), boxPriceJPY: krwToJpy(145000), msrpPackJPY: 180, msrpBoxJPY: 5400, releaseJP: "2025-11-28", packsPerBox: 30,
  },
  SV11B: {
